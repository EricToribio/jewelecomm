...
def new_user_validation(data):
    ...
    elif 'email' in data and  user_model.User.get_one(email=data['email']):
    ...
    # if 'street' in data and len(request.form['street']) < 5:
    #     errors['street']='Enter a valid street'
    # if 'city' in data and len(request.form['city']) < 4:
    #     errors['city']='Enter a valid city'
    # if 'state' in data and len(request.form['state']) < 3:
    #     errors['state']='Enter full State'
    # if 'zip' in data and   len(request.form['zip']) < 5:
    #     errors['zip']='Enter a valid zip code'
    # if 'username' in data and  len(request.form['username']) < 4:
